Assignment 3 -  Portfolio Code: NER Machine Learning 
Eric Shen (Shuyi)     

This folder contains 4 py files, 4 equivalent jupyter notebooks (in case the py files don't work)
and 2 conll2003 files: preprocessing_conll_2021-new, CRF, Train_features_ablation_analysis, 
basic_evaluation, and train / dev conll2003. 

We have to run the py files or notebooks in the following order:  

1. preprocessing_conll_2021-new
2. CRF
3. Train_features_ablation_analysis
4. basic_evaluation
...
I collaborated on this file with J.S. Thomas (Joshua)
------------------------------------------------------------------------------------------------------------------------
